 ...
 * Generated at: 2023-08-17 23:42:31 UTC
...
static {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		\r\n");
      out.write("	//작성자 검증\r\n");
      out.write("	$commentWriter.addEventListener(\"input\", function() {\r\n");
      out.write("	    const inputValue = $commentWriter.value;\r\n");
      ...
      out.write("		    $commentWriter.value = sanitizedValue.substring(0, 10);\r\n");
      out.write("		    $commentWriter.removeEventListener(\"input\", inputHandler);\r\n");
      ...
      out.write("	}\r\n");
      out.write("\r\n");
      out.write("	$commentWriter.addEventListener(\"input\", inputHandler);\r\n");
      out.write("		\r\n");
      out.write("	//비밀번호 검증\r\n");
      out.write("	let isValidPassword = true;\r\n");
      out.write("	let isPasswordAlertShown = false;\r\n");
      out.write("	$commentPw.addEventListener('input', function(event) {\r\n");
      out.write("	    const passwordRegex = /^(?=.*[a-zA-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,15}$/;\r\n");
      out.write("	    isValidPassword = passwordRegex.test($commentPw.value);\r\n");
      out.write("	    isPasswordAlertShown = false;\r\n");
      out.write("	});\r\n");
      out.write("\r\n");
      out.write("	$commentPw.addEventListener('blur', function(event) {\r\n");
      out.write("	    if (!isValidPassword && !isPasswordAlertShown) {\r\n");
      out.write("		    alert('비밀번호는 8자 이상 15자 이하의 영문, 숫자, 특수문자를 모두 포함해야 합니다.');\r\n");
      out.write("		    $commentPw.value = '';\r\n");
      out.write("		    $commentPw.focus();\r\n");
      ...
      out.write("		  \r\n");
      out.write("	//내용 검증  \r\n");
      out.write("	$comment.addEventListener(\"input\", function(event) {\r\n");
      out.write("	    const inputValue = $comment.value;\r\n");
      out.write("	    // HTML 태그를 제거하고 정제된 값의 길이를 체크\r\n");
      out.write("	    const sanitizedValue = inputValue.replace(/<\\/?[^>]+(>|$)/g, \"\");\r\n");
      out.write("	    if (sanitizedValue.length >= 300) {\r\n");
      out.write("	        $content.value = sanitizedValue.substring(0, 300);\r\n");
      out.write("	        event.preventDefault();\r\n");
      out.write("	        alert(\"내용은 최대 300자입니다.\");\r\n");
      out.write("	    }\r\n");
      out.write("	});\r\n");
      out.write("		 \r\n");
      out.write("	$content.addEventListener('keyup', function(event) {\r\n");
      out.write("	    if ($content.value.length >= 300 && !event.ctrlKey) {\r\n");
      out.write("		    $content.value = $content.value.slice(0, 300);\r\n");
